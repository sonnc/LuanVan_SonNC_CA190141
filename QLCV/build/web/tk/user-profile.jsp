...
<html class="loading" lang="en" data-textdirection="ltr">
    <%
        TkUser tku = (TkUser) session.getAttribute("tkUser");
        TkDepartment tkUserDepartment = tku.getTkDepartment();
        TkRole tkUserRole = tku.getTkRole();
    ...
    <body class="vertical-layout vertical-overlay-menu 2-columns   menu-expanded fixed-navbar"
        ...
        <%                                if (session.getAttribute("UoCUserDetailMessage") != null) {
        %>
        <script type="text/javascript">
            swal("Thông báo", "<%=session.getAttribute("UoCUserDetailMessage")%>", "info");
        </script>
        <%
                session.removeAttribute("UoCUserDetailMessage");
            }
        %>
            ...
            <div class="content-wrapper">
                <div class="content-header row">
                    <div class="content-header-left col-md-6 col-12 mb-2">
                        ...
                        <div class="row breadcrumbs-top">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<%=session.getAttribute("httpURL")%>tk/home.jsp"><%=prop.getProperty("tk.tko.label.home")%></a>
                                    </li>
                    ...
                    <div class="content-header-right text-md-right col-md-6 col-12">
                        <div class="btn-group">
                            <button onclick="myFunction()" class="btn btn-round btn-info" type="button"><i class="icon-cog3"></i> <%=prop.getProperty("tk.tko.label.home.user-profiles.editinfo")%></button>
                        </div>
                    </div>
                </div>
                <div class="content-body">
                    <form id="formUoCUserDetail" action="UoCUserDetailAction" method="post" enctype = "multipart/form-data" accept-charset="UTF-8">
...
<!--                                                            <h5><%=prop.getProperty("tk.tko.label.home.user-profiles.avarta")%>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input disabled="true" type="text" name="userName" value="<%=tku.getUserName()%>" class="form-control" required ="Trường này là bắt buộc"/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input disabled="true" value="<%=tku.getUserEmail()%>" type="email" name="userEmail" class="form-control" required="This field is required"/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input disabled="true" value="<%=tkUserRole.getRoleValue()%>" type="text" name="userRole" class="form-control" required="This field is required"/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input disabled="true" value="<%=tkUserDepartment.getDepartmentName()%>" type="text" name="userDepartment" class="form-control" required="This field is required"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
