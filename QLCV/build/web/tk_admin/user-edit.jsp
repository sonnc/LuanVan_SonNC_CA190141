            ...
            <div class="content-wrapper">
                ...
                <div class="content-body">
                    <form id="formUoCUserDetail" action="adminUserCRUDAction" method="post" enctype = "multipart/form-data" accept-charset="UTF-8">
                        <input hidden="true" name="userId" value="<s:property value="tkUser.id"/>"/>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <div class="controls">
                                                                                    <input type="date" name="userDateOfBirth" value="<s:date name = "%{tkUserDetail.userDateOfBirth}" format = "yyyy-MM-dd" />" class="form-control" requiredLabel="true" />
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
