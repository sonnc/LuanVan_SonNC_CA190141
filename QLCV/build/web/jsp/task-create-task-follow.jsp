...
<html>
    <head>
        ...
        <title>Thiết lập theo sau công việc</title>
    </head>
    <body class="vertical-layout vertical-menu 2-columns   menu-expanded fixed-navbar"
        ...
        <div class="app-content content">
            <form  id="formAction"  action="createTaskFollow" method="post" enctype="multipart/form-data">
                <div class="content-wrapper">
                    <div class="content-header row">
                        <div class="content-header-left col-md-6 col-12 mb-2">
                            <h3 class="content-header-title">Thiết lập theo sau công việc</h3>
                        </div>
                                        ...
                                        <div class="card-content collapse show">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group col-12 mb-2 ">
                                                    <div class="row">
                                                        <div class="col-12"> 
                                                            <h4 class="form-section"><i class="ft-user"></i> Thiết lập công việc theo sau</h4>
                                                            <div class="row">
                                                                <div class="col-12">
