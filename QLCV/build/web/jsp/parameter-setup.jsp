            ...
            <div class="content-wrapper">
                <div class="content-header row">
                    <div class="content-header-left col-md-6 col-12 mb-2">
                        <h3 class="content-header-title">Tham số</h3>
                    </div>
                    <div class="content-header-right col-md-6 col-12">
                        <div class="btn-group float-md-right" role="group" aria-label="">
                            <a type="button" class="btn btn-info round box-shadow-2 px-2"  id="btnGroupDrop1"
                               href="<%=session.getAttribute("httpURL")%>jsp/parameter-create.jsp">Tạo tham số</a>        
                                                ...
                                                <tbody>
                                                    <s:iterator value="lstParameterSetup" var="test">
                                                        <tr>
                                                            ...
                                                            <td><s:property value="queryContent"/></td>
