                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <div class="bs-callout-success callout-bordered p-1">
                                                                ...
                                                                <p><%=properties.getProperty("app.workspace.question.create.team")%></p>
                                                            </div>
                                                            <div style="padding-top: 30px; float: right">
                                                                <a type="button" class="btn badge-danger" href="workspaceAction?event="><%=properties.getProperty("app.back")%> </a>
                                                                <a type="button" class="btn badge-info" href="workspaceAction?event=prepareCreateTeamWorkspace&&id=<s:property value="workspace.id"/>"><%=properties.getProperty("app.conitnue")%> </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
