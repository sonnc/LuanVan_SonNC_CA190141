                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group mb-2  col-sm-12 col-md-2">
                                                        <s:textfield type="text" cssClass="form-control" name="sysCodeSet.code"/>
                                                    </div>
                                                    <div class="form-group col-sm-12 col-md-10">
                                                        <s:textfield type="text" cssClass="form-control" name="sysCodeSet.name"/>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div data-repeater-list="createListCodeValue">
                                                        <div class="input-group mb-1" data-repeater-item id="countItemRepeat">
                                                            <div class="form-group mb-1 col-sm-12 col-md-1">
                                                                ...
                                                                <br>
                                                                <s:textfield type="number" name="sysCodeValue.displayOrder" cssClass="form-control" id="example-tel-input"/>
                                                            </div>
                                                            <div class="form-group mb-1 col-sm-12 col-md-3">
                                                                <label for="pass"><%=properties.getProperty("app.codevalue.code")%></label>
                                                                <br>
                                                                <s:textfield type="text" name="sysCodeValue.code" cssClass="form-control" id="example-tel-input"/>
                                                            </div>
                                                            <div class="form-group mb-1 col-sm-12 col-md-3">
                                                                <label for="bio" class="cursor-pointer"><%=properties.getProperty("app.codevalue.code.value")%></label>
                                                                <br>
                                                                <s:textfield type="text" name="sysCodeValue.codeValue" cssClass="form-control" id="example-tel-input"/>
                                                            </div>
                                                            <div class="form-group mb-1 col-sm-12 col-md-3">
                                                                <label for="tel-input"><%=properties.getProperty("app.codevalue.local.code.value")%></label>
                                                                <br>
                                                                <s:textfield type="text" name="sysCodeValue.localCodeValue" cssClass="form-control" id="example-tel-input"/>
                                                            </div>
