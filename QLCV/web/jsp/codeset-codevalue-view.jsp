                    ...
                    <div class="content-header row">
                        ...
                        <div class="content-header-right col-md-6 col-12">
                            <div class="btn-group float-md-right" role="group" aria-label="">     
                                <a href="eventCodeSet?event=prepareEdit&&id=<s:property value="sysCodeSet.id"/>" type="submit" class="btn btn-danger round box-shadow-2 px-2">
                                    <i class="ft-edit"></i> <%=properties.getProperty("app.edit")%></a>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-content collapse show">
                                            <div class="card-body">
                                                <div class="row">
                                                    <input hidden="true" name="event" value="create"/>
                                                    <input hidden="true" name="id" value="0"/>
                                                    ...
                                                    <div data-repeater-list="createListCodeValue">
                                                        ...
                                                        <div class="input-group mb-1" data-repeater-item id="countItemRepeat">
                                                            <div class="form-group mb-1 col-sm-12 col-md-1">
                                                                ...
                                                                <br>
                                                                <s:textfield disabled="true"  type="number" name="displayOrder" cssClass="form-control" id="example-tel-input"/>
                                                            </div>
                                                            <div class="form-group mb-1 col-sm-12 col-md-3">
                                                                <label for="pass"><%=properties.getProperty("app.codevalue.code")%></label>
                                                                <br>
                                                                <s:textfield disabled="true" type="text" name="code" cssClass="form-control" id="example-tel-input"/>
                                                            </div>
                                                            <div class="form-group mb-1 col-sm-12 col-md-3">
                                                                <label for="bio" class="cursor-pointer"><%=properties.getProperty("app.codevalue.code.value")%></label>
                                                                <br>
                                                                <s:textfield disabled="true" type="text" name="codeValue" cssClass="form-control" id="example-tel-input"/>
                                                            </div>
                                                            <div class="form-group mb-1 col-sm-12 col-md-3">
                                                                <label for="tel-input"><%=properties.getProperty("app.codevalue.local.code.value")%></label>
                                                                <br>
                                                                <s:textfield disabled="true" type="text" name="localCodeValue" cssClass="form-control" id="example-tel-input"/>
                                                            </div>
                                                            <div class="form-group mb-1 col-sm-12 col-md-2">
                                                                <label for="tel-input"><%=properties.getProperty("app.status")%></label>
                                                                <br>
                                                                <s:textfield disabled="true" type="text" name="status" cssClass="form-control" id="example-tel-input"/>
                                                            </div>
<!--                                                            <div class="form-group mb-1 col-sm-12 col-md-2" >
