            ...
            <div class="content-wrapper">
                <div class="content-header row">
                    <div class="content-header-left col-md-6 col-12 mb-2">
                        <h3 class="content-header-title mb-0">CHỈNH SỬA TICKET</h3>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="controls">
                                                                                <s:textfield disabled="true" type="text" name="baTypeSeting.baTypeCode" value="%{baTypeSeting.baTypeCode}" cssClass="form-control" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="controls">
                                                                                <select required="true" id="projectinput5" value="" name="baService" class="form-control">
                                                                                    <option value="ADMIN-SERVICE" <s:if test="%{#baTypeSeting.baService == 'ADMIN-SERVICE' }">selected</s:if>>
                                                                                        ADMIN-SERVICE</option>
                                                                                    <option value="IT-SERVICE" <s:if test="%{#baTypeSeting.baService == 'IT-SERVICE' }">selected</s:if>>
                                                                                        IT-SERVICE</option>
                                                                                    <option value="HR-SERVICE" <s:if test="%{#baTypeSeting.baService == 'HR-SERVICE' }">selected</s:if>>
                                                                                        HR-SERVICE</option>
                                                                                    <option value="SUPPORT-SERVICE" <s:if test="%{#baTypeSeting.baService == 'SUPPORT-SERVICE' }">selected</s:if>>
                                                                                        SUPPORT-SERVICE</option>
                                                                                    <option value="OTHER-SERVICE" <s:if test="%{#baTypeSeting.baService == 'OTHER-SERVICE' }">selected</s:if>>
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="controls">
                                                                            <s:textfield required="true" type="text" name="baTypeSeting.baTypeName" value="%{baTypeSeting.baTypeName}" cssClass="form-control" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-5">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="controls">
                                                                                <s:textfield required="true" type="text" name="baTypeSeting.baTypeDesc" value="%{baTypeSeting.baTypeDesc}%" cssClass="form-control" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
